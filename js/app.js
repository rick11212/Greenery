(() => {
    ...
    da.init();
    const menuButton = document.querySelector(".page__button");
    menuButton.addEventListener("click", (function() {
        const menu = document.querySelector(".page__menu");
        const container = document.querySelectorAll(".main__container");
        ...
        const subscribeContainer = document.querySelector(".subscribe__container");
        const footerContainer = document.querySelectorAll(".footer__container");
        menu.classList.toggle("menu-hidden");
        menuButton.classList.toggle("button-ratate");
        logo.classList.toggle("logo-move");
        container.forEach((element => {
            element.classList.toggle("container-margin");
        }));
        partnersContainer.classList.toggle("container-margin");
        productsContainer.classList.toggle("container-margin");
        saleContainer.classList.toggle("container-margin");
        roomsContainer.classList.toggle("container-margin");
        subscribeContainer.classList.toggle("container-margin");
